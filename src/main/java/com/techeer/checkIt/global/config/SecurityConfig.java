...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable().cors().and()
            ...
            .antMatchers("/localhost:15672/").permitAll()   // rabbitmq UI
            .antMatchers("/api/v1/chat/rooms/list").hasRole("ADMIN")                                    // 관리자 권한만 접근 가능
            .antMatchers("/api/v1/chat/rooms").hasRole("USER")
